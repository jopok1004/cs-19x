...
public class SenderActivity extends Activity {
	private File logfile, logfile1;
	private FileWriter fw = null, fw1 = null;
	private BufferedWriter bw = null, bw1 = null;
	...
	private int packetCount; // total number of packets
	private int tracker = 0;
	private int indexLimit;
	private int totalresends = 0;
	private Boolean initialR=false;
	private Boolean check10Received;
	...
	public void exploreFiles(View view) {
		...
		Intent fileExploreIntent = new Intent(SenderActivity.this,
				FileExplore.class);
