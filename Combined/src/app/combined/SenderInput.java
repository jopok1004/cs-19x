...
public class SenderInput extends Activity {
	
	/** Called when the activity is first created. */
	
//	public void onCreate(Bundle savedInstanceState) {
//	    super.onCreate(savedInstanceState);
//	    setContentView(R.layout.senderinput);
...
//	    final TextView pcount = (TextView) findViewById(R.id.totalpcount);
//	   // Intent intent = getIntent();
//		//intent.getStringExtra("start?");
//		//pcount.setText("Total number of packets: " + intent.getStringExtra("packetCount").toString());
//	    
//	    nextBt.setOnClickListener(new View.OnClickListener() {
//			public void onClick(View v) {
//				Intent intent = new Intent(SenderInput.this,
//						SenderInitial.class);
//				
